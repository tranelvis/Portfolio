...
public class MockUserData extends Storage {
    ...
    public static void createMockData() {
        ...
        long daySteps = MainActivity.user.getDailySteps().getStepsForDate(date);
        long stepGoal = MainActivity.user.getStepGoals().getStepGoalForDate(date);
        DayData d1 = new DayData(daySteps, stepGoal, MainActivity.user.getWalksAndRuns(), date);
        ...
        daySteps = MainActivity.user.getDailySteps().getStepsForDate(date);
        stepGoal = MainActivity.user.getStepGoals().getStepGoalForDate(date);
        DayData d2 = new DayData(daySteps, stepGoal, MainActivity.user.getWalksAndRuns(), date);
        ...
        daySteps = MainActivity.user.getDailySteps().getStepsForDate(date);
        stepGoal = MainActivity.user.getStepGoals().getStepGoalForDate(date);
        DayData d3 = new DayData(daySteps, stepGoal, MainActivity.user.getWalksAndRuns(), date);
