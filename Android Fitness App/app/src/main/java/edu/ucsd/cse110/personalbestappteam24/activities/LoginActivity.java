...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnLogA = findViewById(R.id.buttonlogA);
        btnLogA.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.setAreMocking(true);
                MainActivity.setMockEmail("A");
                launchMainActivity();
            }
        });

        Button btnLogB = findViewById(R.id.buttonlogB);
        btnLogB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MainActivity.setAreMocking(true);
                MainActivity.setMockEmail("B");
                launchMainActivity();
            }
        });

        if (!MainActivity.areMocking) {
            btnLogA.setVisibility(View.INVISIBLE);
            btnLogB.setVisibility(View.INVISIBLE);
        }
        ...
        clearDataButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences sharedPreferences = getApplicationContext().getSharedPreferences("A", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.clear();
                editor.apply();

                sharedPreferences = getApplicationContext().getSharedPreferences("B", Context.MODE_PRIVATE);
