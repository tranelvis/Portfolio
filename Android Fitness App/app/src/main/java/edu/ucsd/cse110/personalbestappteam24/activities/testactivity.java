...
public class testactivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_testactivity, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_testactivity, container, false);

            chart = (CombinedChart) rootView.findViewById(R.id.chartWeek1);
            //SetGraph set = new SetGraph(getActivity(), 1);
            //chart = set.getChart();
            return rootView;
        }
    }
